...
export const financeApi = {
  ...
  // Remise persistée (réduction du dû d'un mois×service, sans encaissement)
  applyDiscount: (studentId, data) => request(`/api/finance/students/${studentId}/apply-discount`, { method: 'POST', body: data }),
