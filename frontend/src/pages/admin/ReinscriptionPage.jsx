...
// Petite carte statistique de l'entonnoir.
...
const ReinscriptionPage = () => {
  ...
  const [rows, setRows] = useState([]); // { student_id, name, avatar, avatar_url, currentClass, currentLevel, new_class_id, status }
  ...
  return (
    <div className="p-2 md:p-6 max-w-6xl mx-auto space-y-6">
      ...
      {/* Entonnoir d'inscription de l'année active */}
      <Card>
      ...
      {/* Lancement de l'assistant de réinscription vers l'année suivante */}
      {!wizardOpen && (
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {loadingWizard ? (
              ...
              <>
                {/* Avertissement si aucune classe pour l'année cible */}
