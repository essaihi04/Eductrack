  ...
  return (
    <div className="p-3 sm:p-6 max-w-7xl mx-auto pb-20 md:pb-6">
      ...
      <TaskModal
        ...
        busy={saving}
        title={editingControl ? t('planif.editControl') : t('planif.newControl')}
        subtitle={t('cp.compactFormHint')}
        closeLabel={t('common.close')}
        maxWidth="max-w-3xl"
        footer={(
          <>
            <button type="button" onClick={() => setShowCreateModal(false)} disabled={saving}
      ...
      >
        <div className="grid gap-3 sm:grid-cols-2">
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700">{t('planif.classRequired')}</label>
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700">{t('planif.nameRequired')}</label>
            <input type="text" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} required
              className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500" />
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700">{t('planif.dateRequired')}</label>
          ...
          <div className="sm:col-span-2">
            <label className="mb-1 block text-sm font-medium text-gray-700">{t('planif.description')}</label>
