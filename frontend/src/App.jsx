...
import CockpitJourneePage from './pages/admin/CockpitJourneePage';
...
import NotesRecapPage from './pages/admin/NotesRecapPage';
      ...
      <Router>
        <Routes>
          ...
          >
            ...
            <Route path="admin/journee" element={<CockpitJourneePage />} />
            ...
            <Route path="admin/notes-recap" element={<NotesRecapPage />} />
