...
export default function StudentInscriptionModal({ open, onClose, classes = [], academicYear, onCreated }) {
  ...
  const [created, setCreated] = useState(null); // élève créé (écran de confirmation)
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl my-6" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white rounded-t-xl z-10">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold">Fiche d'inscription — Nouvel élève{academicYear ? ` · ${academicYear}` : ''}</h3>
          </div>
        ...
        {created ? (
          ...
          <div className="p-5 space-y-4">
            <div className="flex items-start gap-2 p-3 rounded-lg bg-green-50 border border-green-200 text-green-800 text-sm">
              ...
              <span><b>{created.first_name} {created.last_name}</b> a été inscrit(e). Communiquez ces identifiants :</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="p-4 space-y-5 max-h-[78vh] overflow-y-auto">
            ...
            {/* ── Identifiants (auto-générés si vides) ── */}
            <section className="space-y-2">
