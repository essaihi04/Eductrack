...
const roleData = {
  ...
  parent: {
    ...
    body: 'Le parent pose ses questions au chatbot et retrouve les détails dans son portail : absences, devoirs, progression, rendez-vous, finance et transport.',
    outcomes: ['Des réponses personnalisées, en français ou en arabe', 'Un espace sécurisé pour chacun de ses enfants', 'Moins d’appels répétitifs au secrétariat'],
  ...
  student: {
    ...
    icon: GraduationCap,
    color: '#E8B447',
    image: '/images/landing-v2/student-growth-compass.webp',
    imageAlt: 'Parcours personnel d’un élève de la maternelle au baccalauréat',
    headline: 'Mon histoire scolaire me suit et mes progrès deviennent visibles.',
    body: 'De la maternelle au bac, l’élève retrouve ses repères pendant que l’école construit une vision continue de ses résultats, ses qualités et ses besoins.',
    outcomes: ['Progression observée sur plusieurs années', 'Qualités et réussites réellement valorisées', 'Points à renforcer transformés en actions'],
  ...
  teacher: {
    ...
    icon: BookOpen,
    color: '#2A9D8F',
    image: '/images/landing-v2/teacher-classroom-followup.webp',
    imageAlt: 'Professeure accompagnant et suivant ses élèves pendant une séance',
